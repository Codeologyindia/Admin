                    ...
                    <form method="POST" action="#" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="guardian_name" class="form-control" placeholder="Enter guardian name" value="{{ old('guardian_name') }}">
                            </div>
                            {{-- DOB --}}
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="problam" class="form-control" placeholder="Enter problam" value="{{ old('problam') }}">
                            </div>
                            {{-- Aadhaar --}}
                            <div class="col-md-3">
                                <label class="form-label">Aadhaar Number</label>
                                <input type="text" name="aadhaar_number" class="form-control" placeholder="Enter Aadhaar number" value="{{ old('aadhaar_number') }}">
                            </div>
                            {{-- Ayushman Number --}}
                            <div class="col-md-3">
                                <label class="form-label">Ayushman Number</label>
                                <input type="text" name="ayushman_number" class="form-control" placeholder="Enter Ayushman number" value="{{ old('ayushman_number') }}">
                            </div>
                            {{-- Other Document --}}
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" name="amount" id="amountInput" class="form-control" placeholder="Enter full payment amount" oninput="updateLeftPayment()" value="{{ old('amount') }}">
                            </div>
                            {{-- Paid Now --}}
                            <div class="col-md-3">
                                <label class="form-label">Paid Now</label>
                                <input type="number" name="paid_amount" id="paidAmountInput" class="form-control" placeholder="Enter amount paid now" oninput="updateLeftPayment()" value="{{ old('paid_amount') }}">
                            </div>
                            {{-- Left Payment --}}
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="payment_id" class="form-control" placeholder="Enter payment transaction ID" value="{{ old('payment_id') }}">
                            </div>
                        </div>
