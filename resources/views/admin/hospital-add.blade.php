...
@section('topbar-title', 'Add Hospital')
        ...
        <div class="col-12 col-md-12 p-0 m-0">
            <div class="card shadow-sm border-0" style="border-radius:0;">
                <div class="card-body p-4" style="font-size:0.75rem;">
                    <h3 class="fw-bold mb-4 text-center" style="color:#232946;">Add Hospital</h3>
                    @if ($errors->any())
                    ...
                    <form method="POST" action="{{ route('admin.hospital.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="hospital_name" class="form-control" placeholder="Enter hospital or clinic name" value="{{ old('hospital_name') }}">
                            </div>
                            <div class="col-md-6">
